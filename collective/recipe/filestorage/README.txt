...
plone.recipe.zope2zeoserver recipes.  It also creates the directories in which
...
zeo
    The name of a plone.recipe.zope2zeoserver part to which we want to add the
    extra filestorage.  Defaults to the first plone.recipe.zope2zeoserver part
...
zopes
    ...
    connected to the associated plone.recipe.zope2zeoserver part, if any, or all
...
blob-storage
    ...
    or a ZEO server. Optional. Defaults to 'var/blobstorage-%(fs_part_name)s'.
zeo-blob-storage
